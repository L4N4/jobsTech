    ...
    <x-guest-layout>
        ...
        <div class="flex items-center justify-center p-4 mt-10 ">
            ...
            <div class="max-w-5xl  bg-white w-full rounded-lg shadow-xl">
                ...
                <div class=" flex justify-end mx-5 text-blue-500 hover:text-blue-700 ">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="max-w-xl mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-3xl">
                        <div class="md:flex">
                            ...
                            <div class="p-8">
                                ...
                                <p class="mt-2 text-justify text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    ...
                    <div class="flex flex-wrap m-4 border-b-2 border-blue-100">
                        <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 p-4 mb-6 text-center">
                            ...
                            <div class="flex justify-center mt-3">
                                <div>
                                    <button
                                        class="cursor-default bg-blue-600 text-white my-3 text-sm rounded-3xl px-3 py-1">Liderazgo</button>
                                    <button
                                        class="cursor-default bg-blue-600 text-white my-3 text-sm rounded-3xl px-3 py-1">Trabajo
                                        en equipo</button>
                                    <button
                                        class="cursor-default bg-blue-600 text-white my-3 text-sm rounded-3xl px-3 py-1">Creatividad</button>
                                    <button
                                        class="cursor-default bg-blue-600 text-white my-3 text-sm rounded-3xl px-3 py-1">Comunicación
                                        efectiva</button>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-wrap m-4 border-b-2 border-blue-100">
                        <div class=" p-4 w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 p-4 mb-1 text-center">
                            <x-jet-label class="my-2 pt-4 text-center font-bold" for=""
                                ...
                                <p class="my-2 pt-4 text-justify text-sm text-gray-500" for="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe dolorum facilis nam consequuntur aut numquam vitae quam ullam officia cupiditate, placeat magnam, deserunt debitis ipsum? Aliquam et maiores eius culpa!</p>

                        </div>

                        <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 p-4 mb-6 text-center">
                            <x-jet-label class="my-2 pt-4 text-center font-bold" for="" value="{{ __('Idioma - Nivel:') }}" />
                            <label class="my-2 pt-4 text-center  text-sm text-gray-500" for="">Español - Avanzado</label><br>
                            <label class="my-2 pt-4 text-center  text-sm text-gray-500" for="">Inglés - Intermedio</label><br>
                    ...
                    <div class="flex items-center justify-center mt-4">
                        <x-jet-button type="submit" style="background-color: #2563EB" class="ml-4">
