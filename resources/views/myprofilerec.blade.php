                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-wrap m-4 border-b-2 border-blue-100">
                        <div class="w-full p-4 mb-6 text-center">
                            <x-jet-label class="my-2 pt-4 text-center font-bold" for="" value="{{ __('Link del sitio web de la empresa:') }}" />
                    ...
                    <div class="flex flex-wrap m-4 border-b-2 border-blue-100">
                        <!--Job list card start-->
                        <div class="w-full p-4 mb-6 text-center">
                            <x-jet-label class="my-2 pt-4 text-center font-bold" for="" value="{{ __('Vacantes disponibles de la empresa:') }}" />
